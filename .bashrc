...
promptCustom(){
  if [ $? -eq 0 ]; then
					PS1="\n${CYAN}┌─\$(venvONprompt)─(${NC}${MAGENTA}\u@\h${NC}${CYAN})─[${NC}${LGRAY}\w${NC}${CYAN}]\$(gitONprompt) ${LGRAY}\@${NC} ${CYAN}[${NC}${LGREEN}O${NC}${CYAN}]\n${NC}${CYAN}└─${NC}${MAGENTA}\$${NC} "
  else 
    PS1="\n${CYAN}┌─\$(venvONprompt)─(${NC}${MAGENTA}\u@\h${NC}${CYAN})─[${NC}${LGRAY}\w${NC}${CYAN}]\$(gitONprompt) ${LGRAY}\@${NC} ${CYAN}[${NC}${LRED}X${NC}${CYAN}]\n${NC}${CYAN}└─${NC}${MAGENTA}\$${NC} "
  fi
}
